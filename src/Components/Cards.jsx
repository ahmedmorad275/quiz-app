...
const Cards = () => {
  return (
    <section className="cards grid grid-cols-1 gap-4 mt-8 md:grid-cols-3 justify-between items-center mb-3">
      <div className="hover:-translate-y-2 transition-all duration-300 flex flex-col justify-center items-center  bg-(--card) px-10 py-4 border border-(--primary)/40 shadow-sm text-(--card-foreground) rounded-xl">
        <LuBrain />
